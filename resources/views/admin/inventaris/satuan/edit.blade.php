...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Edit Unit Barang</h4>
                
                <form method="POST" action="{{ route('item-units.update', $itemUnit) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('item_id') is-invalid @enderror" 
                            ...
                            <option value="{{ $item->id }}" {{ old('item_id', $itemUnit->item_id) == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="serial_number" 
                                       name="serial_number" 
                                       value="{{ old('serial_number', $itemUnit->serial_number) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="inventory_code" 
                                       name="inventory_code" 
                                       value="{{ old('inventory_code', $itemUnit->inventory_code) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('condition') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $key }}" {{ old('condition', $itemUnit->condition) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $key }}" {{ old('status', $itemUnit->status) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
