                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($item->specification)
                                                    <br><small
                                                        class="text-muted">{{ Str::limit($item->specification, 50) }}</small>
                                                @endif
                                            </td>
                                            <td>
                                    ...
                                    <span>{{ $item->item_units_count }} unit</span>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex flex-column gap-1">
                                                    ...
                                                    @if ($damaged > 0)
                                                        <span class="badge badge-warning">{{ $damaged }}
                                                            bermasalah</span>
                                                    @endif
                                                </div>
                                            </td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('items.update', $item) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label>Spesifikasi</label>
                                                    <textarea name="specification" class="form-control">{{ $item->specification }}</textarea>
                                                </div>
                                            </div>
