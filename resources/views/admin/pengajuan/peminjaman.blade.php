                        ...
                        <div class="col-md-2">
                            <select name="status" class="form-select"
                                ...
                                <option value="overdue" {{ request('status') == 'overdue' ? 'selected' : '' }}>
                                    Overdue / Terlambat</option>
                                <option value="return_pending"
                                    {{ request('status') == 'return_pending' ? 'selected' : '' }}>Pengajuan Pengembalian
                                </option>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            @forelse($loans as $loan)
                                <tr
                                    class="{{ in_array($loan->status, ['borrowed', 'overdue']) && $loan->return_date < now() ? 'table-danger' : '' }}">
                                    ...
                                    <td>
                                        ...
                                        @if (in_array($loan->status, ['borrowed', 'overdue']) && $loan->return_date < now())
                                            <br><small class="text-danger"><i class="mdi mdi-alert-circle"></i>
                                                Terlambat</small>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        @switch($loan->status)
                                            ...
                                            @case('approved')
                                                <span class="badge bg-primary"><i
                                                        class="mdi mdi-check-circle-outline me-1"></i>Disetujui</span>
                                            @break

                                            @case('borrowed')
                                                @if ($loan->return_request_status == 'pending')
                                                    <span class="badge text-white" style="background-color:#6f42c1"><i
                                                            class="mdi mdi-keyboard-return me-1"></i>Pengajuan Kembali</span>
                                                @else
                                                    <span class="badge bg-info"><i
                                                            class="mdi mdi-bookmark-outline me-1"></i>Dipinjam</span>
                                                @endif
                                            @break

                                            @case('overdue')
                                                <span class="badge bg-danger"><i
                                                        class="mdi mdi-alert-circle-outline me-1"></i>Overdue</span>
                                            @break

                                            @case('returned')
                                                <span class="badge bg-success"><i
                                                        class="mdi mdi-check-all me-1"></i>Dikembalikan</span>
                                            @break

                                            @case('rejected')
                                                <span class="badge bg-danger"><i
                                                        class="mdi mdi-close-circle-outline me-1"></i>Ditolak</span>
                                            @break

                                            @case('cancelled')
                                                <span class="badge bg-secondary"><i
                                                        class="mdi mdi-cancel me-1"></i>Dibatalkan</span>
                                            @break
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" id="confirmBorrowedForm">
                        @csrf
                        <div class="modal-header text-dark">
                            <h5 class="modal-title"><i class="mdi mdi-bookmark-check-outline me-2"></i>Konfirmasi Pengambilan
                            </h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                ...
                <div class="modal-content">
                    <form method="POST" id="approveReturnForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Kondisi Barang per Unit <span
                ...
                <div class="modal-content">
                    <form method="POST" id="rejectReturnForm">
                        ...
                        <div class="modal-header bg-danger text-white">
                            <h5 class="modal-title"><i class="mdi mdi-close-circle-outline me-2"></i>Tolak Pengajuan
                                Pengembalian</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                if (d.return_request_notes) {
                                    document.getElementById('approve-return-request-notes').textContent = d
