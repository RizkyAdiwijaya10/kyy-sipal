            ...
            <div class="table-responsive">
                <table class="table table-hover" id="reportTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @switch($loan->status)
                                    ...
                                    @case('approved') <span class="badge bg-info">Disetujui</span> @break
                                    @case('borrowed') <span class="badge bg-primary">Dipinjam</span> @break
                        ...
                        @empty
                        <tr><td colspan="8" class="text-center text-muted py-5">Tidak ada data peminjaman<\/td><\/tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
...
function printReport() {
    ...
    var printWindow = window.open('{{ route("admin.reports.print") }}?start_date={{ request('start_date') }}&end_date={{ request('end_date') }}&status={{ request('status') }}', '_blank');
}
</script>
@endpush
@endsection